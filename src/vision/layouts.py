...
# --- Active Faults ---
ACTIVE_FAULTS_ERROR_CODE_1 = OCRField( # right = 0.33 just for code.
	name="active_faults_error_code_1",
	ideal=ROIBox(top=0.15, bottom=0.30, left=0.05, right=0.92),
...
ACTIVE_FAULTS_ERROR_CODE_2 = OCRField(
	...
	ideal=ROIBox(top=0.30, bottom=0.45, left=0.05, right=0.92),
	fallback=ROIBox(top=0.15, bottom=0.35, left=0.05, right=0.95),
	whitelisted_chars="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789. ",
)
...
ACTIVE_FAULTS_ERROR_CODE_3 = OCRField(
	...
	ideal=ROIBox(top=0.45, bottom=0.60, left=0.05, right=0.92),
	fallback=ROIBox(top=0.15, bottom=0.35, left=0.05, right=0.95),
	whitelisted_chars="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789. ",
)
...
ACTIVE_FAULTS_ERROR_CODE_4 = OCRField(
	...
	ideal=ROIBox(top=0.60, bottom=0.75, left=0.05, right=0.92),
	fallback=ROIBox(top=0.15, bottom=0.35, left=0.05, right=0.95),
	whitelisted_chars="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789. ",
)
...
ACTIVE_FAULTS_ERROR_CODE_5 = OCRField(
	...
	ideal=ROIBox(top=0.75, bottom=0.90, left=0.05, right=0.92),
	fallback=ROIBox(top=0.15, bottom=0.35, left=0.05, right=0.95),
	whitelisted_chars="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789. ",
)
